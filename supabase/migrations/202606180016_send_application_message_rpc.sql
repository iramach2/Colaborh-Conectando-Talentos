...
revoke all on function public.send_application_message(uuid, text, text) from public;
grant execute on function public.send_application_message(uuid, text, text) to authenticated;
