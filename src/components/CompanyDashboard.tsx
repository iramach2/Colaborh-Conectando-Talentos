                ...
                {selectedJob === null && (
                  <div className="mb-6 flex items-center justify-between">
                    ...
                    <button 
                      type="button"
                      onClick={() => { setIsRegisteringVacancy(true); setRegisterStep(1); }}
                      className="flex items-center justify-center gap-2 w-40 py-2.5 bg-[#7c3aed] hover:bg-[#6d28d9] text-white rounded-full text-[10px] font-black uppercase tracking-widest transition-all duration-300 hover:shadow-md hover:shadow-[#7c3aed]/20 active:scale-95 border-0 cursor-pointer shrink-0 hover:-translate-y-0.5"
                    >
