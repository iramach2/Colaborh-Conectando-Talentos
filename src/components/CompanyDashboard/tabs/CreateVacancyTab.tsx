  ...
  return (
    <div className="fixed inset-0 z-[200] flex justify-end overflow-hidden">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-[600px] h-full bg-white/95 backdrop-blur-md rounded-l-[24px] shadow-2xl overflow-hidden flex flex-col border-l border-slate-200/60 z-10"
      >
        {/* Step Header - Compact & Premium */}
        <div className="px-8 pt-8 pb-4 relative">
          <div className="max-w-lg mx-auto w-full">
            <div className="relative pb-3 border-b border-slate-100 w-full">
              <h2 className="text-lg font-black text-slate-800 uppercase tracking-wider text-left">CADASTRAR NOVA VAGA</h2>
              <div className="absolute bottom-0 left-0 w-24 h-[2.5px] bg-[#533af6]" />
            </div>
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar flex flex-col justify-between">
              ...
              >
                ...
                <div className="flex flex-col gap-1.5 text-left">
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl outline-none focus:bg-white focus:border-[#533af6] focus:ring-4 focus:ring-[#533af6]/5 transition-all text-slate-900 font-medium text-xs shadow-2xs hover:border-slate-350" 
                  />
                  <p className="text-[10px] text-slate-450 italic mt-0.5 pl-1 leading-normal">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                      ...
                      <select 
                        ...
                        className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl outline-none focus:bg-white focus:border-[#533af6] transition-all text-slate-900 font-bold text-xs appearance-none cursor-pointer shadow-2xs hover:border-slate-350"
                      >
                  ...
                  {(vacancyForm.modality === 'Presencial' || vacancyForm.modality === 'Híbrido') && (
                    <div className="grid grid-cols-3 gap-2">
                      <div className="flex flex-col gap-1.5">
                        <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest pl-1">UF <span className="text-rose-500">*</span></label>
                        <div className="relative">
                          <ChevronDown size={12} className="absolute right-2 top-1/2 -translate-y-1/2 text-slate-450 pointer-events-none" />
                          <select 
                            className="w-full px-2 py-2.5 bg-white border border-slate-200 rounded-xl font-bold text-xs outline-none focus:bg-white focus:border-[#533af6] appearance-none cursor-pointer shadow-2xs hover:border-slate-350"
                      ...
                      <div className="col-span-2 flex flex-col gap-1.5">
                        <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest pl-1">Cidade <span className="text-rose-500">*</span></label>
                        <div className="relative">
                          <ChevronDown size={14} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-450 pointer-events-none" />
                          <select 
                            className="w-full px-3 py-2.5 bg-white border border-slate-200 rounded-xl font-bold text-xs outline-none focus:bg-white focus:border-[#533af6] appearance-none disabled:opacity-50 cursor-pointer shadow-2xs hover:border-slate-350"
                  ...
                  <div className="flex flex-col gap-1.5">
                    {vacancyForm.remunerationType === 'Fixo' && (
                      <>
                        ...
                        <input 
                          ...
                          placeholder="R$ 0,00" 
                          className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl outline-none focus:bg-white focus:border-[#533af6] focus:ring-4 focus:ring-[#533af6]/5 transition-all text-slate-900 font-bold text-xs shadow-2xs hover:border-slate-350" 
                        />
                      </>
                    )}
                    {vacancyForm.remunerationType === 'Faixa Salarial' && (
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          <label className="text-[8px] font-black text-slate-500 uppercase tracking-wider pl-1 mb-0.5 block">Mínimo <span className="text-rose-500">*</span></label>
                          <input 
                            type="text" 
                            value={vacancyForm.salaryMin}
                            onChange={handleSalaryMinChange}
                            placeholder="R$ 0,00" 
                            className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl outline-none focus:bg-white focus:border-[#533af6] text-slate-900 font-bold text-xs shadow-2xs hover:border-slate-350" 
                          />
                        </div>
                        <div>
                          <label className="text-[8px] font-black text-slate-500 uppercase tracking-wider pl-1 mb-0.5 block">Máximo <span className="text-rose-500">*</span></label>
                          <input 
                            type="text" 
                ...
                <div className="bg-slate-50/50 p-4 rounded-2xl border border-slate-100 flex flex-col gap-3 text-left shadow-2xs">
                  ...
                  {vacancyForm.hasBonus && (
                    <div className="grid grid-cols-2 gap-2 animate-in fade-in slide-in-from-top-2 pt-2 border-t border-slate-100">
                      <div className="relative">
                        <ChevronDown size={12} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-455 pointer-events-none" />
                        <select 
                          value={vacancyForm.bonusType}
                          onChange={(e) => setVacancyForm((prev: any) => ({ ...prev, bonusType: e.target.value }))}
                          className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-[10px] font-bold uppercase outline-none focus:border-primary-300 appearance-none pl-3 pr-8 cursor-pointer shadow-2xs hover:border-slate-350"
                        >
                      ...
                      <input 
                        ...
                        className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-[10px] font-bold outline-none focus:border-[#533af6] shadow-2xs hover:border-slate-350"
                      />
                    </div>
                  )}
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                      <ChevronDown size={14} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-455 pointer-events-none" />
                      <select 
                ...
                {/* Benefícios */}
                <div className="flex flex-col gap-1.5 text-left">
                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest pl-1">Benefícios Oferecidos</label>
                  <div className="grid grid-cols-2 gap-2">
                    {[
                      ...
                      return (
                        <div key={ben.id} className="bg-slate-50/50 p-2.5 rounded-xl border border-slate-150 flex flex-col gap-2 shadow-2xs">
                          <button 
                            type="button"
                            onClick={() => {
                              if (ben.hasValue) {
                            ...
                            className={`w-full py-1.5 px-2 rounded-lg border font-bold text-[9px] uppercase tracking-wider transition-all cursor-pointer ${
                              isSelected
                          ...
                          {ben.hasValue && isSelected && (
                            <input 
                              ...
                              className="w-full px-2 py-1 bg-white border border-slate-200 rounded text-[9px] font-bold outline-none focus:border-[#533af6] shadow-2xs hover:border-slate-350"
                            />
                          )}
                  ...
                  <div className="flex gap-1.5 mt-1.5">
                    <input 
                      ...
                      className="flex-1 px-3 py-1.5 bg-white border border-dashed border-slate-200 rounded-xl text-[9.5px] font-semibold outline-none focus:border-[#533af6] placeholder:normal-case shadow-2xs hover:border-slate-350"
                      onKeyDown={(e) => {
                        if (e.key === 'Enter') {
                          e.preventDefault();
                          if (newBenefit.trim()) {
                    ...
                    {newBenefit && (
                      <button 
                        ...
                        className="px-2.5 bg-[#533af6] hover:bg-[#4326e5] text-white rounded-xl flex items-center justify-center transition-all cursor-pointer shadow-xs active:scale-95"
                      >
                        <Plus size={10} />
                      </button>
                    )}
              ...
              >
                ...
                <div className="flex flex-col gap-1.5 text-left">
                  ...
                  <input 
                    ...
                    placeholder="Ex: 2" 
                    className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl outline-none focus:bg-white focus:border-[#533af6] transition-all text-slate-900 font-bold text-xs shadow-2xs hover:border-slate-350" 
                  />
                  <p className="text-[10px] text-slate-455 italic mt-0.5 pl-1 leading-normal">
                ...
                <div className="bg-slate-50/50 p-4 rounded-2xl border border-slate-100 flex flex-col gap-4 text-left shadow-2xs animate-in fade-in duration-300">
                  ...
                  {vacancyForm.isPcd && (
                    <div className="flex flex-col gap-1.5 animate-in fade-in slide-in-from-top-2 duration-200">
                      <label className="text-[8px] font-black text-slate-505 uppercase tracking-widest pl-1">
                      ...
                      <input 
                        ...
                        className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl outline-none focus:border-[#533af6] text-xs font-medium text-slate-950 shadow-2xs hover:border-slate-350" 
                      />
                    </div>
                  )}
                  ...
                  <div className="flex flex-col gap-1 pt-2 border-t border-slate-100">
                    <div className="flex justify-between items-center mb-0.5">
                      <label className="text-[8px] font-black text-slate-500 uppercase tracking-widest">Idade Mínima</label>
                ...
                {/* Requisitos */}
                <div className="flex flex-col gap-1.5 text-left">
                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest pl-1">Requisitos da Vaga</label>
                    ...
                    {commonRequirements.map(req => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-2.5 py-1.5 rounded-full text-[8.5px] font-black uppercase tracking-wider transition-all cursor-pointer ${
                            isSelected 
                              ? 'bg-[#533af6] text-white shadow-sm' 
                  ...
                  <div className="flex gap-1.5">
                    <input 
                      ...
                      className="flex-1 px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-semibold outline-none focus:border-[#533af6] shadow-2xs hover:border-slate-350"
                      onKeyDown={(e) => {
                        if (e.key === 'Enter') {
                          e.preventDefault();
                    ...
                    {newRequirement && (
                      <button 
                        ...
                        className="px-3 bg-[#533af6] hover:bg-[#4326e5] text-white rounded-xl flex items-center justify-center cursor-pointer transition-all shadow-xs active:scale-95"
                      >
                        <Plus size={12} />
                      </button>
                    )}
                  ...
                  {vacancyForm.requirements.length > 0 && (
                    <div className="bg-slate-50/50 p-3 rounded-xl border border-dashed border-slate-200 mt-2 shadow-2xs">
                      <div className="flex flex-wrap gap-1.5">
                        {vacancyForm.requirements.map((r, i) => (
                          <div key={i} className="flex items-center gap-1.5 bg-white px-2.5 py-1 rounded-lg border border-slate-150 text-[9px] font-bold text-slate-600 shadow-2xs">
                            <span>{r}</span>
                            <button 
                              type="button"
              ...
              >
                ...
                <div className="flex flex-col gap-1.5 text-left">
                  ...
                  <textarea 
                    ...
                    className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl outline-none focus:bg-white focus:border-[#533af6] transition-all font-medium text-slate-700 text-xs italic leading-relaxed shadow-2xs hover:border-slate-350" 
                  />
                  <p className="text-[10px] text-slate-455 italic pl-1 leading-normal">
                ...
                <div className="flex flex-col gap-2 text-left">
                  ...
                  <div className="space-y-2 max-h-[220px] overflow-y-auto pr-1">
                    {vacancyForm.stages.map((stage, index) => {
                      ...
                      return (
                        <div key={index} className="group flex items-center gap-3 bg-slate-50/80 px-4 py-2.5 rounded-xl border border-slate-100 hover:border-[#533af6]/30 transition-all shadow-2xs hover:shadow-xs">
                          <div className="w-6 h-6 bg-white rounded-lg shadow-xs flex items-center justify-center font-black text-[#533af6] text-xs border border-slate-100">
                            {index + 1}
                          </div>
                  ...
                  <div className="flex gap-2 mt-2">
                    <input 
                      ...
                      className="flex-1 px-4 py-2 bg-white border border-dashed border-slate-200 rounded-xl font-medium text-xs outline-none focus:border-[#533af6] focus:border-solid transition-all shadow-2xs hover:border-slate-350"
                      onKeyDown={(e) => {
                        if (e.key === 'Enter') {
                          e.preventDefault();
                          if (newStage.trim()) {
                  ...
                  <p className="text-[10px] text-slate-455 italic pl-1 leading-normal mt-1">
          ...
          {/* Modal Footer */}
          <div className="px-8 py-5 border-t border-slate-100 bg-slate-50/50 shadow-sm">
            {errorMessage && (
            ...
            <div className="max-w-lg mx-auto w-full flex justify-between items-center gap-4">
              {registerStep > 1 ? (
                <button 
                  ...
                  className="px-6 py-2 bg-white border border-slate-200 hover:bg-slate-55 text-slate-655 hover:text-slate-800 rounded-full text-[12px] font-[650] uppercase tracking-wider transition-all duration-300 hover:shadow-xs active:scale-95 cursor-pointer"
                >
                  Voltar
                </button>
              ) : (
              ...
              {registerStep < 4 ? (
                <button 
                  ...
                  className="px-8 py-2 bg-[#533af6] hover:bg-[#4326e5] text-white rounded-full text-[12px] font-[650] uppercase tracking-wider transition-all duration-300 shadow-md shadow-[#533af6]/10 hover:shadow-lg hover:shadow-[#533af6]/20 hover:-translate-y-0.5 active:scale-95 cursor-pointer"
                >
                  Próximo Passo
                </button>
              ) : (
                <button 
                  ...
                  className={`px-8 py-2 bg-[#533af6] hover:bg-[#4326e5] text-white rounded-full text-[12px] font-[650] uppercase tracking-wider transition-all duration-300 shadow-md shadow-[#533af6]/10 hover:shadow-lg hover:shadow-[#533af6]/20 hover:-translate-y-0.5 active:scale-95 ${isPublishing ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}
                >
