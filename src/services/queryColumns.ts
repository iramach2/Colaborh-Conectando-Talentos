export const APPLICATION_COLUMNS = 'id, job_id, talent_id, candidate_user_id, candidate_name, candidate_email, candidate_phone, status, city, state, profile_pic, created_at' as const;
